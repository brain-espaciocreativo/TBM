...
export default function NewsForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            Swal.fire({
                title: 'Ocurrio un error al intentar crear la novedad',
            })
        }
    }
    ...
    const handleAdd = () => {
        if (selectedCategory.name === '') {
            return Swal.fire({
                title: 'llene los campos para añadir categoria',
            })
        }
                                    ...
                                    <Grid container>
                                        <TextField
                                            ...
                                            sx={{
                                                marginTop: '2rem',
                                                boxShadow:
                                                    '5px 5px 13px 2px rgba(0,0,0,0.39)',
                                        ...
                                        <FormControl sx={{ marginTop: '1rem' }}>
                                            ...
                                            >
                                                ...
                                                categories.length ? (
                                                    ...
                                                    <MenuItem value="No hay caregorias">
                                                        No hay categorias
                                                    </MenuItem>
                                                )}
                                            </Select>
