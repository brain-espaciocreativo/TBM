...
export default function ListUserDashboard() {
    ...
    const createUser = async () => {
        ...
        if (
            ...
            !createUserState.surname ||
            !createUserState.email ||
            !createUserState.password ||
            !createUserState.role ||
...
*/
    ...
    const handlePass = async (e) => {
        ...
        await axios
            .put(
                `${config.apiURL}/user/updatepasswordEmail/${passState.email}`,
                {
                    email: passState.email,
                    pass: password,
                }
            )
            .then((res) => {
    ...
    const bodyInsert = (
        <div className={styles.modal}>
            <Typography className="Encabezado">Agregar Usuario</Typography>
            <TextField
            ...
            <div>
                ...
                <Button onClick={handleModalCreate} color="error">
                    Cancelar
                </Button>
            </div>
        </div>
    ...
    const bodyEdit = (
        <div className={styles.modal}>
            <Typography className="Encabezado">Editar Usuario</Typography>
            <TextField
            ...
            <div align="right">
                ...
                <Button onClick={handleModalEdit} color="error">
                    Cancelar
                </Button>
            </div>
        </div>
    ...
    const bodyChangePass = (
        <div className={styles.modal2}>
            <form className="" style={{ backgroundColor: '#f3eaeb' }}>
                ...
                <div>
                    ...
                    <Button onClick={handleModalPass} color="error">
                        Cancelar
                    </Button>
                </div>
            </form>
    ...
    return (
        <div>
                ...
                <Table>
                    <TableHead>
                        <TableRow sx={{ margin: 5 }}>
                            <TableCell sx={{ color: 'rgb(160,7,7)' }}>
                                Nombre
                            </TableCell>
                            <TableCell sx={{ color: 'rgb(160,7,7)' }}>
                                Apellido
            ...
            <Modal open={modalPass} onClose={setModalPass}>
                {bodyChangePass}
            </Modal>
        </div>
    )
